...
window.I18N = {
    en: {
        ...
        conv_block: "Subnet",
        conv_fee: "Broker percent",
        conv_fee_head: "broker",
        conv_sum24: "Sum/24",
        conv_fee_ip: "fee/IP",
        conv_fee24: "fee/24",
        conv_total24: "Sum/24 + fee",
...
<a href="https://github.com/Michael-VT/ipv4_aggregator#readme">README</a>.</p>`,
    ...
    ua: {
        ...
        conv_fee: "Відсоток брокера",
        conv_fee_head: "брокеру",
        conv_sum24: "Сума/24",
        conv_fee_ip: "коміс./IP",
        conv_fee24: "коміс./24",
        conv_total24: "Сума/24 + коміс.",
...
<a href="https://github.com/Michael-VT/ipv4_aggregator#readme">README</a>.</p>`,
    ...
    ru: {
        ...
        conv_block: "Подсеть",
        conv_fee: "Процент брокера",
        conv_fee_head: "брокеру",
        conv_sum24: "Сумма/24",
        conv_fee_ip: "комис./IP",
        conv_fee24: "комис./24",
        conv_total24: "Сумма/24 + комис.",
...
<a href="https://github.com/Michael-VT/ipv4_aggregator#readme">README</a>.</p>`,
    ...
    pt: {
        ...
        conv_block: "Sub-rede",
        conv_fee: "Percentual do corretor",
        conv_fee_head: "corretor",
        conv_sum24: "Soma/24",
        conv_fee_ip: "taxa/IP",
        conv_fee24: "taxa/24",
        conv_total24: "Soma/24 + taxa",
...
<a href="https://github.com/Michael-VT/ipv4_aggregator#readme">README</a>.</p>`,
    ...
    de: {
        ...
        conv_block: "Subnetz",
        conv_fee: "Maklerprozent",
        conv_fee_head: "Makler",
        conv_sum24: "Summe/24",
        conv_fee_ip: "Geb./IP",
        conv_fee24: "Geb./24",
        conv_total24: "Summe/24 + Geb.",
...
<a href="https://github.com/Michael-VT/ipv4_aggregator#readme">README</a>.</p>`,
    ...
    fr: {
        ...
        conv_fee: "Pourcentage du courtier",
        conv_fee_head: "courtier",
        conv_sum24: "Somme/24",
        conv_fee_ip: "comm./IP",
        conv_fee24: "comm./24",
        conv_total24: "Somme/24 + comm.",
